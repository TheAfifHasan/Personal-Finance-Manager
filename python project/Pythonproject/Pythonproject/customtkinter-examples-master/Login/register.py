...
CTkLabel(master=frame, text="Sign UP NOW!", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 24)).pack(anchor="w", pady=(50, 5), padx=(25, 0))
CTkLabel(master=frame, text="Sign UP with your email and password", text_color="#7E7E7E", anchor="w", justify="left", font=("Arial Bold", 12)).pack(anchor="w", padx=(25, 0))
...
CTkLabel(master=frame, text="Click sign up fore create your account", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 12)).pack(anchor="w", pady=(50, 5), padx=(25, 0))
...
CTkButton(master=frame, text="Back to Sign in", fg_color="#EEEEEE", hover_color="#E44982", font=("Arial Bold", 12), text_color="#601E88", width=225,  command=signup).pack(anchor="w", pady=(20, 0), padx=(25, 0))
